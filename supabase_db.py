...
writes to the actual "Makstore_Full_Feed_Master" table via PostgREST, using the
...
TABLE_NAME = "Makstore_Full_Feed_Master"  # case-sensitive - matches the quoted identifier in the table DDL
