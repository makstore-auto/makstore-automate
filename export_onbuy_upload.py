"""Builds the OnBuy product-upload CSV for the Makstore store.
...
Column values:
  ...
  pre-validated UPC - non-digit decoration like "MAK-" is allowed in the
...
Usage: same GOOGLE_CREDENTIALS env as generate_xml.py.
    python export_onbuy_upload.py     -> writes Makstore_OnBuy_Upload.csv
"""
import csv
import json
import os
...
OUTPUT_FILE = "Makstore_OnBuy_Upload.csv"
